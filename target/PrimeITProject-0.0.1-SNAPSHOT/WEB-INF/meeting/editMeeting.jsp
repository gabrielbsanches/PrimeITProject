...
<tbody>  
     ...
     <tr>  
        <th>Company Name:</th>  
        <td align="left"><input type="text" name="company_name" value="${meeting.company_name}"></></td>  
    </tr> 
    <tr>  
        <th>Client Name:</th>  
        <td align="left"><input type="text" name="client_name" value="${meeting.client_name}"></></td>  
    </tr>  
     <tr>  
        <th>Meeting Date:</th>  
